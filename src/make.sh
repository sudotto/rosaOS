...
ld -m elf_i386 -T linker.ld -o rosaOS boot.o kernel.o vga.o memory.o keyboard.o string.o disk.o io.o shell.o
dd if=/dev/zero of=disk.img bs=512 count=32768

# clean up

rm boot.o kernel.o vga.o memory.o keyboard.o string.o disk.o io.o shell.o
